...
export function AddToCartModal({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 space-y-4 animate-scale-in" style={{ backgroundColor: '#FFFDD0' }}>
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <Package className="w-10 h-10" style={{ color: '#50C878' }} />
              <CheckCircle className="w-5 h-5 absolute -bottom-1 -right-1" style={{ color: '#50C878' }} />
            </div>
            <div>
